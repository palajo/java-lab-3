...
public class Tank extends AbstractWartechnic {
    ...
    public Tank(double engineVolume, double fuelConsumption, int maxSpeed, int passengersCapacity, double fireRange, Levels damage, int armorType, Levels patency, int overviewInDegrees) {
